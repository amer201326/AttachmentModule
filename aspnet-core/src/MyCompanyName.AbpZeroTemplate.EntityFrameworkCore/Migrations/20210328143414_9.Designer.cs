...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.Attachments.AttachmentEntityType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ArName = "شخص",
                            CreationTime = new DateTime(2021, 3, 28, 17, 34, 13, 185, DateTimeKind.Local).AddTicks(1215),
                            EnName = "Person",
                        ...
                        new
                        {
                            Id = 2,
                            ArName = "مرض",
                            CreationTime = new DateTime(2021, 3, 28, 17, 34, 13, 185, DateTimeKind.Local).AddTicks(4204),
                            EnName = "Desease",
                            Folder = "/Desease",
                            IsDeleted = false,
                            ParentTypeId = 1
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.Attachments.AttachmentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ArName = "صورة الهوية",
                            CreationTime = new DateTime(2021, 3, 28, 17, 34, 13, 178, DateTimeKind.Local).AddTicks(9456),
                        ...
                        new
                        {
                            ...
                            AllowedExtensions = "jpg,png",
                            ArName = "تشخيص المرض",
                            CreationTime = new DateTime(2021, 3, 28, 17, 34, 13, 182, DateTimeKind.Local).AddTicks(2688),
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.Test.TestEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.Attachments.AttachmentEntityType", b =>
                {
                    b.HasOne("MyCompanyName.AbpZeroTemplate.Attachments.AttachmentEntityType", "ParentTypeFk")
                        .WithMany()
                        .HasForeignKey("ParentTypeId");

                    b.Navigation("ParentTypeFk");
                });

            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.Attachments.AttachmentFile", b =>
                {
                    b.HasOne("MyCompanyName.AbpZeroTemplate.Attachments.AttachmentType", "AttachmentTypeFk")
                        .WithMany()
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.Attachments.AttachmentType", b =>
                {
                    b.HasOne("MyCompanyName.AbpZeroTemplate.Attachments.AttachmentEntityType", "EntityTypeFk")
                        .WithMany()
