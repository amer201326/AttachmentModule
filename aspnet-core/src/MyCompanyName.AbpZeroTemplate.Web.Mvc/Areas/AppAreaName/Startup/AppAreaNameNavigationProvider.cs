    ...
    public class AppAreaNameNavigationProvider : NavigationProvider
    {
        ...
        public override void SetNavigation(INavigationProviderContext context)
        {
            ...
            menu
                ...
                .AddItem(new MenuItemDefinition(
                        AppAreaNamePageNames.Common.AttachmentTypes,
                        L("AttachmentTypes"),
                        url: "AppAreaName/AttachmentTypes",
                        icon: "flaticon-more",
                        permissionDependency: new SimplePermissionDependency(AppPermissions.Pages_AttachmentTypes)
                    )
                )
                .AddItem(new MenuItemDefinition(
                        AppAreaNamePageNames.Common.AttachmentEntityTypes,
                        L("AttachmentEntityTypes"),
                        url: "AppAreaName/AttachmentEntityTypes",
                        icon: "flaticon-more",
                        permissionDependency: new SimplePermissionDependency(AppPermissions.Pages_AttachmentEntityTypes)
                    )
                )
                .AddItem(new MenuItemDefinition(
                        AppAreaNamePageNames.Common.TestEntities,
                        L("TestEntities"),
                        url: "AppAreaName/TestEntities",
                        icon: "flaticon-more",
